...
template <typename PointType>
void IKDTree<PointType>::Set_delete_criterion_param(float delete_param){
    delete_criterion_param = delete_param;
}

template <typename PointType>
void IKDTree<PointType>::Set_balance_criterion_param(float balance_param){
    balance_criterion_param = balance_param;
}

template <typename PointType>
void IKDTree<PointType>::set_downsample_param(float downsample_param){
...
template <typename PointType>
void IKDTree<PointType>::Search(KD_TREE_NODE * root, int k_nearest, PointType point, MANUAL_HEAP &q, double max_dist){
    if (root == nullptr || root->tree_deleted) return;   
...
template <typename PointType> bool IKDTree<PointType>::point_cmp_x(PointType a, PointType b) { return a.x < b.x;}
template <typename PointType> bool IKDTree<PointType>::point_cmp_y(PointType a, PointType b) { return a.y < b.y;}
template <typename PointType> bool IKDTree<PointType>::point_cmp_z(PointType a, PointType b) { return a.z < b.z;}
